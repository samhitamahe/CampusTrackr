...
const Dash = () => {
  ...
  return (
    <main className="self-center">
      <h2 className="m-6 mx-auto text-center font-spectral text-6xl font-bold dark:text-slate-400">
        CampusTrackr
      </h2>
      <div className="grid grid-cols-1 place-content-center gap-3 px-1 py-4 lg:grid-cols-2 lg:gap-4 lg:px-8 xl:grid-cols-3">
        <Link
          className="flex gap-2 rounded-lg bg-violet-300 p-6 text-base duration-200 hover:bg-violet-400/90 dark:bg-violet-950/80 dark:hover:bg-violet-950 dark:hover:text-slate-300 lg:text-lg"
          to={"./paper"}
        >
