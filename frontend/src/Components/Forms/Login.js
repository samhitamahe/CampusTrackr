    ...
    <>
      {!user?._id ? (
        <main className="relative z-0 flex h-screen flex-col items-center justify-center bg-gradient-to-b from-slate-400 to-slate-300 text-slate-950 dark:from-slate-800 dark:to-slate-950 dark:text-slate-300">
          {message && !error && (
            <header className="absolute top-0 w-full bg-[#023E8A]/50 p-2 text-xs dark:bg-slate-700/50 lg:text-base">
              {message}
            </header>
          )}
          <CircleDesign />
          ...
          <section className="z-0 w-[65%] justify-self-center rounded-lg bg-[#E0AAFF] opacity-80 duration-200 hover:opacity-100 focus:opacity-100 dark:bg-[#240046] sm:w-[min(50%,360px)] md:w-[min(40%,360px)] xl:w-[min(23%,360px)] ">
            <form
            ...
            >
              <section className="flex flex-col items-center justify-start ">
                ...
                <div className="flex w-full justify-center p-1 pt-0 text-8xl duration-200 dark:border-x-[1.5px] dark:border-solid dark:border-violet-900 md:p-3 md:pt-0">
                  {userType === "student" ? (
              ...
              <section className="rounded-b-lg px-4 pb-4 dark:border-x-[1.5px] dark:border-b-[1.5px] dark:border-solid dark:border-violet-900">
                {userType ? (
                  ...
                  <p className="my-12 w-full rounded bg-violet-300 p-4 text-center duration-200 dark:bg-violet-950/90">
                    Select User Type
                  </p>
                )}
